...
# Import Langfuse decorators with fallback for when langfuse is not available
try:
    ...
    class MockLangfuseContext:
        ...
        def get_current_langchain_handler(self): return None
        def get_current_trace_id(self): return "mock_trace"
